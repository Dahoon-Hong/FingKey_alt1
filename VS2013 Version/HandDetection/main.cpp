...
void waitForPalmCover(MyImage* m){
    m->cap >> m->src;
	flip(m->src,m->src,1);
	roi.push_back(My_ROI(Point(m->src.cols/2.5, m->src.rows/4),Point(m->src.cols/2.5+square_len,m->src.rows/4+square_len),m->src));
	roi.push_back(My_ROI(Point(m->src.cols/3, m->src.rows/2),Point(m->src.cols/3+square_len,m->src.rows/2+square_len),m->src));
	roi.push_back(My_ROI(Point(m->src.cols/2.7, m->src.rows/1.5),Point(m->src.cols/2.7+square_len,m->src.rows/1.5+square_len),m->src));
	...
	roi.push_back(My_ROI(Point(m->src.cols/2.2, m->src.rows/1.5),Point(m->src.cols/2.2+square_len,m->src.rows/1.5+square_len),m->src));
